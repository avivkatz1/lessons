...
const LEVEL_INFO = {
  1: { title: "Addition Equations", instruction: "Solve equations like x + a = b" },
  2: { title: "Subtraction Equations", instruction: "Solve equations like x − a = b" },
  3: { title: "Multiplication Equations", instruction: "Solve equations like ax = b" },
  4: { title: "Division Equations", instruction: "Solve equations like x ÷ a = b" },
  5: { title: "Mixed Equations", instruction: "Solve one-step equations with any operation" },
};
...
function OneStepEquations({ triggerNewProblem }) {
  const {
    lessonProps,
    showAnswer,
    revealAnswer,
    ...
    <Wrapper>
      ...
      {phase === "choose" && (
        <ChooseSection>
          ...
          <ChoosePrompt>Pick the correct operation to isolate x:</ChoosePrompt>
      ...
      {phase === "type" && (
        <TypeSection>
          <StepDisplay>
            <StepLabel>{correctChoiceText}:</StepLabel>
      ...
      {phase === "complete" && (
        <ExplanationSection>
          ...
          <StepByStep>
            ...
            <StepRow>
              <StepNum>2</StepNum>
              <StepContent>{correctChoiceText}</StepContent>
            </StepRow>
            <StepRow>
              <StepNum>3</StepNum>
              <StepContent>{intermediateStep}</StepContent>
            </StepRow>
            <StepRow>
              <StepNum>4</StepNum>
              <StepContent><strong>{simplifiedEquation}</strong></StepContent>
            </StepRow>
          </StepByStep>
