...
const LEVEL_INFO = {
  1: {
    title: 'SSS Recognition',
    instruction: 'Look at the two triangles and determine if they are congruent by SSS.',
  },
  2: {
    title: 'Match Corresponding Sides',
    instruction: 'Identify which sides from Triangle ABC match sides in Triangle DEF.',
  },
  3: {
    title: 'Find the Congruent Pair',
    instruction: 'Which pair of triangles is congruent by SSS?',
  },
  4: {
    title: 'Find the Missing Side',
    instruction: 'Use SSS congruence to find the length of the missing side.',
  },
  5: {
    title: 'Real-World Application',
    instruction: 'Apply SSS congruence to solve the problem.',
  },
};
...
function SSSCongruentTrianglesLesson({ triggerNewProblem }) {
  const {
    lessonProps,
    showAnswer,
    revealAnswer,
  ...
  return (
    <Wrapper>
      ...
      {/* ===== Level 2: Classify Corresponding Sides ===== */}
...
export default SSSCongruentTrianglesLesson;
