...
import MovablePointsAndLinesParallel from "../MovablePointsAndLinesParallel";
const ParallelLinesButton = ({
  handleClick,
  parallel,
  x = 20,
  y = 0,
  ...
  const [points, setPoints] = useState([
    { id: 0, x: x + 10 + objPos.x, y: y + 130 + objPos.y },
  ...
  return (
    <>
      <Line stroke={"black"} points={[x + 10, y + 25, x + 60, y + 5]} />
      <Line stroke={"black"} points={[x + 30, y + 25, x + 80, y + 5]} />
      <Rect
        id="parallel"
        x={x}
        y={y}
...
export default ParallelLinesButton;
